...
| 3 | HU-F10.3 | Cierre diario (cierra todas las sesiones del día) | ~200 LOC nominal → ~1240 LOC forecast (strict_tdd 5-7x pattern) | depende F10.2 (cierre_turno pattern) | pendiente — **size:exception RATIFIED** (4to consecutivo en repo, F9.1 +940 + F10.1 +1566 + F10.2 +2037 precedentes). 8 atomic tasks (T1 schema, T2 useArqueoResumenPorSesion + deprecate useCierreDiario, T3 cierreDiarioChain helper, T4 form, T5 page, T6 route, T7 i18n, T8 e2e). Spec REQ-OPS-163..169 (7 ADDED requirements, 16 scenarios). 9 drift anchors resolved (DA-F10.3-1..8 + NEW-DA-F10.3-9). Pending ABBC-F10.3-BE-1 (JWT perm delta) + ABBC-F10.3-FE-1 (F10.1 aggregate Zod reconciliation). |
