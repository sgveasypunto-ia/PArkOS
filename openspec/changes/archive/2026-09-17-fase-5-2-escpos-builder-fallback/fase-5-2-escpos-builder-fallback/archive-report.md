...
All tasks implemented and merged into `dev` per git log (commit `584c7b2` â€” see
...
- Phase implementation commit: **`584c7b2`** (see `git log --grep`)
...
```bash
git mv openspec/changes/archive/2026-09-17-fase-5-2-escpos-builder-fallback openspec/changes/fase-5-2-escpos-builder-fallback
